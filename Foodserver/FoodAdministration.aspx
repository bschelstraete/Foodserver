                ...
                <div class="panel-body pnlFoodAdmin">
                    ...
                    <div id="overviewAdmin" runat="server" class="col-md-12">
                        ...
                        <div id="addNewOptionPage" runat="server" class="col-md-12 form-group">
                            <div id="divNewOption" runat="server" class="form-group"></div>
                            <div id="divNewMealOption" runat="server" class="form-group"></div>
                        </div>
                    </div>
                </div>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:Button CommandArgument='<%# ((GridViewRow) Container).DataItemIndex + ";" + "DELETE" %>' ID="btnDelete" Text="Verwijder" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate >
                                        ...
                                        <asp:Button  CommandArgument='<%# ((GridViewRow) Container).DataItemIndex + ";" + "DELETE" %>' runat="server" ID="btnDelete" Text="Verwijderen" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
